export const projects = {
  ...
  wefa: {
    ...
    problem:
      "Growing up I was outside all the time playing with local neighbors and using our environment to fit whatever game we were playing. During those times things like gardening or lawncare were viewed as chores and avoided activties. However, as I reflect back it was a connective tissue to my community and neighbors. I recall meeting one of my closet childhood friends through him offering to help pick up leaves. In addition now having a home garden and growing vegetables, herbs, and fruits has taught me organic taste so much better. With a greater appreaciation, understanding for plants and our environment, I'm building WEFA as way for youth to plant deeper roots and adults reconnect or better connect with their communitiy and nature.",
    architecture:
      "WEFA aims to make cultivating your environment fun whether it's a single plant in a bedroom or garden full of them. Now many will ask how can that be fun many have tried and fail or downright find plants and caring for them boring. I'll now ask how many play or have played games like Farmville, Minecraft, Pokemon Go, WoW or others spending countless hours? For those who have or do WEFA is a platform connecting nature and games with Augmented Reality, Blockchains, and AI to create a symbiotic relationship between the two. Helping individuals and communities find short term and long term success in health, social connection and sustainability. I've told my story to WEFA, now below is the plot for the initial comic release of WEFA in correlation with the platform and the initial game, think pokemon if that helps.",
    development:
      "A group of cozllege kids find themselves on an unexpected journey where worlds collide. Taking place in 2027 in a recently industrialized town in Nigeria now apart of a larger country called Wau (wa-ooo), with a newly minted prestigious university funded by a multinational corporation known as CoeUp. Known for a rare mineral finding almost 100 years ago and since then pillaging the local lands unknownignly causing an imbalance between two worlds. The most brightest & privileged students from all corners of the world are chosen to attend the univeristy, with a few locals allowed. In an unexpected turn during a class cave exhibition the group gain a set of unique abilities when wandering off into a cave and an earthquake hits. Though all coming from different places they learn to trust each other and forge a deep connection not only to one another but to this new world they've found through their abilities. Learning from their community and a unique old healer who may be the only one with the knowledge to fight CoeUp and restore balance.",
    links: [
      {
        label: 'Learn More',
        link: 'https://wefa.app',
