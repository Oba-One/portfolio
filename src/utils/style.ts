...
type CssVariableInput = Record<string, CssVariableValue>
type CssVariableOutput = CSSProperties & Record<`--${string}`, CssVariableValue>

export function cssProps(
  props: CssVariableInput,
  style: CSSProperties = {}
): CssVariableOutput {
  const result: Record<`--${string}`, CssVariableValue> = {}
 ...
 */
export function classes(...classNames: Array<string | false | null | undefined>) {
